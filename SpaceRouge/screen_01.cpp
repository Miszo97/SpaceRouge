...
screen_01::screen_01(){
    ...
    std::string path = "/Users/miszo97/Desktop/SpaceRouge/SpaceRouge/Resources/SmallObstacleTextureSprite.png";
    if (!Textures[0].loadFromFile(path)) {
        std::cerr << "Error loading SmallObstacleTextureSprite.png" << std::endl;
        //return (-1);
    }
    
    path = "/Users/miszo97/Desktop/SpaceRouge/SpaceRouge/Resources/MediumObstacleTextureSprite.png";
    if (!Textures[1].loadFromFile(path)) {
        std::cerr << "Error loading MediumObstacleTextureSprite.png" << std::endl;
        //return (-1);
    }
    
    path = "/Users/miszo97/Desktop/SpaceRouge/SpaceRouge/Resources/BigObstacleTextureSprite.png";
    ...
    path = "/Users/miszo97/Desktop/SpaceRouge/SpaceRouge/Resources/boom3.png";
